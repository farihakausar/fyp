   ...
   <div class="p-4 lg:w-1/2">
      ...
      <div class="p-12  flex flex-col items-start">
        ...
        <p class="leading-relaxed mb-8">Live-edge letterpress cliche, salvia fanny pack humblebrag narwhal portland. VHS man braid palo santo hoodie brunch trust fund. Bitters hashtag waistcoat fashion axe chia unicorn. Plaid fixie chambray 90's, slow-carb etsy tumeric. Cray pug you probably haven't heard of them hexagon kickstarter craft beer pork chic.</p>
         ...
         <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900  mb-4">Students</h2>
      ...
      <div class="p-12  flex flex-col items-start">
        ...
        <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900  mb-4">Subjects</h2>
        ...
        <button class="text-white bg-indigo-500 border-0 m-3 py-2 px-10 focus:outline-none hover:bg-indigo-600 rounded text-lg"><a href='/virtualclassroom'>Virtaul classroom 1</a></button>
        <button class="text-white bg-indigo-500 border-0 m-3 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"><a href='/createchat'>Virtaul classroom  2</a></button>
