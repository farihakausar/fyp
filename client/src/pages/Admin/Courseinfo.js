...
function Courseinfo() {
  ...
  return (
    ...
    <div>
      <h5  className=" text-center text-customBlue font-medium italic" style={{ fontSize: "50px" }}>your course details 
      </h5>
   
   <div className="p-6">
        
        <Tabs defaultActiveKey="1">
        <Tabs.TabPane tab={<span style={{ color: '#FF6347',fontStyle:"italic"  }}>Add Course</span>} key="1" >
            <AddCourse/>
          </Tabs.TabPane>
          <Tabs.TabPane  tab={<span style={{ color: '#FF6347' ,fontStyle:"italic" }}>Added Course</span>} key="2">
            <AddedCourse />
          </Tabs.TabPane>
