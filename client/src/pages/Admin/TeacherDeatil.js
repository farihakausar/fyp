  ...
  return (
   ...
   <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src={teacherRequest.photo}/>
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-gray-900">{teacherRequest.course}</h2>
            <h3 class="text-gray-500 mb-3">{teacherRequest.
educationDetail}</h3>
      ...
      <div class="p-12  flex flex-row items-start justify-between">
        ...
        <div>
        <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-2">Price</h2>
      ...
      <div class="p-12  flex flex-col items-start">
        ...
        <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900  mb-4">Timing</h2>
        ...
        <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900  mb-4">CV </h2>
        <a href={teacherRequest.pptFile} class="leading-relaxed mb-8" target="_blank">Check pdf file</a>
