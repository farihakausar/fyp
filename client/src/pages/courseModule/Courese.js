...
<div class="relative mb-4">
    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
      ...
      <div class="mb-10 md:mb-16">
        <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">cpiyrese</h2>
        ...
        <div class="flex flex-col overflow-hidden rounded-lg border bg-white">
          ...
          <div class="flex flex-1 flex-col p-4 sm:p-6">
            <h2 class="mb-2 text-lg font-semibold text-gray-800">
              <a href={`/coursedetail/${course._id}`}  class="transition duration-100 hover:text-indigo-500 active:text-indigo-600">mern stack{course.courseName} </a>
            </h2>
  
            <p class="mb-8 text-gray-500">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text. {course.courseDesc} </p>
            ...
            <div class="mt-auto flex items-end justify-between">
              <div class="flex items-center gap-2">
                ...
                <div>
                  <span class="block text-indigo-500">html css javascrput {course.tech}</span>
                  <span class="block text-sm text-gray-400">vs code bjnbjkn{course.tool}</span>
                </div>
              </div>
  
              <span class="rounded border px-2 py-1 text-sm text-gray-500 font-bold"> rpice{course.tool}</span>
            </div>
          </div>
        </div>
