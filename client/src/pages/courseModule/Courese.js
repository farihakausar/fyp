          ...
          <div class="flex flex-1 flex-col p-4 sm:p-6">
            ...
            <div class="mt-auto flex items-end justify-between">
              <div class="flex items-center gap-2">
                ...
                <div>
                  <span class="block text-indigo-500">html css javascrput</span>
                  <span class="block text-sm text-gray-400">vs code bjnbjkn</span>
                </div>
              </div>
  
              <span class="rounded border px-2 py-1 text-sm text-gray-500 font-bold">400</span>
            </div>
          </div>
        </div>
