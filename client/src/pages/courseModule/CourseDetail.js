    ...
    <div class="grid gap-8 md:grid-cols-2">
      ...
      <div class="md:py-8">
        ...
        <div class="flex gap-2.5">
          <a href="/student" class="inline-block flex-1 rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 sm:flex-none md:text-base">enrolled</a>
