...
export default function AddHomeService() {
  ...
  const handleAddService = async () => {
    ...
    try {
      ...
      console.log(response.data,"post"); // Assuming the response contains a success message
  ...
  <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <form  className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            <label htmlFor="timing" className="block text-sm font-semibold leading-6 text-gray-900">
             timing
            </label>
            <div className="mt-2.5">
              <input
          ...
          Education detail
            ...
            <div className="mt-2.5">
              <input
                type="email"name='educationDetail'
