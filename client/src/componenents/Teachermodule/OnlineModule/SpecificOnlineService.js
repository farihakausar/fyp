      ...
      case 'pdf':
        return (
          <div className="mb-4">
            ...
            <input type="file" id="file" name="file" accept=".pdf" onChange={handleChange} className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
            ...
            <div className="mb-4">
              ...
              <input type="text" id="courseTitle" name="courseTitle" onChange={handleChange} value={material.courseTitle} className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
            </div>
          </div>
      ...
      default:
        return (
          <div className="mb-4">
            ...
            <textarea id="note" name="note" onChange={handleChange} value={material.note} className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"></textarea>
          </div>
        );
    }
  };
