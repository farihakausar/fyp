...
<a href="/loginTeacher" class="inline-flex hover:bg-white hover:border-2 py-2 px-6 bg-customBlue   hover:border-dashed hover:border-customBlue rounded text-lg ml-4 transition duration-300">Join as Teacher</a>
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
      ...
      <a href="#" class="group relative flex h-48 flex-col overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-64 xl:h-96">
        <img src={online} loading="lazy" alt="Photo by Minh Pham" class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
        ...
        <div class="relative mt-auto p-4">
          ...
          <h2 class="mb-2 text-xl font-semibold text-red-600 transition duration-100">Online Tutor</h2>
      ...
      <a href="#" class="group relative flex h-48 flex-col overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-64 xl:h-96">
        <img src={home} loading="lazy" alt="Photo by Lorenzo Herrera" class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />

        <div class="pointer-events-none absolute inset-0 bg-gradient-to-t from-gray-800 to-transparent md:via-transparent"></div>

        <div class="relative mt-auto p-4">
        <h2 class="mb-2 text-xl font-semibold text-red-600 transition duration-100">Home Tutor</h2>
        </div>
      </a>
      ...
      <a href="#" class="group relative flex h-48 flex-col overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-64 xl:h-96">
        <img src={course} loading="lazy" alt="Photo by Martin Sanchez" class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />

        <div class="pointer-events-none absolute inset-0 bg-gradient-to-t from-gray-800 to-transparent md:via-transparent"></div>

        <div class="relative mt-auto p-4">
        <h2 class="mb-2 text-xl font-semibold text-red-600 transition duration-100">Course</h2>
        </div>
      </a>
...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 class="title-font sm:text-4xl text-xl mb-4 font-medium text-red-600">Features Of
         Tute me
      </h1>
      <p class="mb-8 leading-relaxed  italic">The Home Tutor module provide to students seeking personalized and face-to-face tutoring experiences. 
Online Tutor. students can connect with expert tutors from around the world, using virtual tools and interactive features for perfect communication. 
Online Course Module. If any student wants to learn about specific subject and don’t want to hire tutor, then he/she can register for online course</p>
     
    </div>
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img class="object-cover object-center rounded" alt="hero" src={main1}/>
    </div>
  </div>
</section>
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base italic text-customBlue">Team of Tute me Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium itaque iure optio architecto.</p>
    </div>
    <div class="flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/4 md:w-1/2">
        <div class="h-full flex flex-col items-center text-center">
          ...
          <div class="w-full">
            <h2 class="title-font font-medium text-lg text-red-600">Alper Kamu</h2>
            <h3 class="text-customBlue mb-3">UI Developer</h3>
            <p class="mb-4 italic">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quaerat, nisi obcaecati?</p>
      ...
      <div class="p-4 lg:w-1/4 md:w-1/2">
        <div class="h-full flex flex-col items-center text-center">
          ...
          <div class="w-full">
            <h2 class="title-font font-medium text-lg text-red-600">Holden Caulfield</h2>
            <h3 class="text-customBlue mb-3">UI Developer</h3>
            <p class="mb-4 italic">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quaerat, nisi obcaecati?</p>
      ...
      <div class="p-4 lg:w-1/4 md:w-1/2">
        <div class="h-full flex flex-col items-center text-center">
          ...
          <div class="w-full">
            <h2 class="title-font font-medium text-lg text-red-600">Atticus Finch</h2>
            <h3 class="text-customBlue mb-3">UI Developer</h3>
            <p class="mb-4 italic">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quaerat, nisi obcaecati?</p>
      ...
      <div class="p-4 lg:w-1/4 md:w-1/2">
        <div class="h-full flex flex-col items-center text-center">
          ...
          <div class="w-full">
            <h2 class="title-font font-medium text-lg text-red-600">Henry Letham</h2>
            <h3 class="text-customBlue mb-3">UI Developer</h3>
