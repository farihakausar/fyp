...
export default function MyHometutor() {
  return (
    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
      ...
      <div class="grid gap-4 sm:grid-cols-2 md:gap-8 xl:grid-cols-3">
        ...
        <div class="flex flex-col rounded-lg border p-4 md:p-6">
          ...
          <p class="mb-4 text-gray-500">Filler text is dummy text which has no meaning however looks very similar to real text.</p>
          <a href="/detail" class="mt-auto font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
        </div>
