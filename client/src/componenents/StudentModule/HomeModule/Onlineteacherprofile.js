...
export default function Onlineteacherprofile() {
  ...
  <div class="p-4 lg:w-1/2">
      ...
      <div class="p-12  flex flex-col items-start">
        ...
        <p class="leading-relaxed mb-8">Live-edge letterpress cliche,.</p>
        <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900  mb-4">price</h2>
        <p class="leading-relaxed mb-8">Live-edge letterpress cliche,.</p>

        <div className='lg:w-1/3 md:w-1/2 bg-white flex flex-row md:m-auto w-full md:py-8 mt-8 md:mt-0'>
        <button class="text-white bg-indigo-500 border-0 m-3 py-2 px-10 focus:outline-none hover:bg-indigo-600 rounded text-lg"><a href='/booking'>Book</a></button>
