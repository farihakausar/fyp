...
export default function Payment() {
  return (
    ...
    <div class="p-12  flex flex-col items-start">
     ...
     <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-2 m-auto">Payment</h2>
     ...
     <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"><a href='/Classroom'>Done</a></button>
