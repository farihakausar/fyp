            ...
            >
              ...
              <div className="relative p-10">
                <div className="mt-2">
                  ...
                  <div>
                    <div className="p-2">
                    <h1 class="title-font  text-3xl mb-4 font-medium transition italic text-white duration-500 transform hover:scale-110">Get Home teacher services<br class="hidden lg:inline-block"/> </h1>
  ...
  rooms.map((room, index) => (
    <div key={index} className="p-4 md:w-1/3">
      <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
        <img className="lg:h-48 md:h-36 w-full object-cover object-center" src={room.photo} alt="blog" />
        <div className="p-6">
          {/* <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2> */}
          <h1 className="title-font text-lg font-medium text-gray-900 mb-3">{room.course}</h1>
          <p className="leading-relaxed mb-3">{room.about}</p>
          <div className="flex items-center flex-wrap mb-2">
            <span className="text-gray-400 inline-flex items-center leading-none text-sm mr-4">
              ...
              </svg>Timing: {room.timing}
            </span>
            <span className="text-gray-400 inline-flex items-center leading-none text-sm mr-4">
              <svg className="w-4 h-4 mr-1" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                <circle cx="12" cy="12" r="3"></circle>
              </svg>Price: {room.price}
            </span>
            <span className="text-gray-400 inline-flex items-center leading-none text-sm">
              <svg className="w-4 h-4 mr-1" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                <circle cx="12" cy="12" r="3"></circle>
              </svg>Location:{room.address}
            </span>
          </div>
          <div>
          
            <a className="text-indigo-500 inline-flex items-center" href={`/teacherprofile/${room._id}`}>
              Learn More
