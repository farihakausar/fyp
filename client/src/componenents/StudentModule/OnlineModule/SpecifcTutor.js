...
<div class="p-4 lg:w-1/2 rounded-lg">
  ...
  <p class="leading-relaxed mb-8 "> about teacher</p>
    </div>
  </div>
</div>
...
<div class="lg:w-1/3 md:w-1/2 flex flex-row md:m-auto w-full md:py-8 mt-8 md:mt-0">
  ...
  <button class="text-white bg-indigo-500 border-0 m-3 py-2 px-10 focus:outline-none hover:bg-indigo-600 rounded text-lg"><a href='/virtualclassroom'>classroom</a></button>
